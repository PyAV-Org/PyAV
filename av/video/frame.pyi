...
class VideoFrame(Frame):
    ...
    def to_ndarray(self, force_channel_last: bool = False, **kwargs: Any) -> _SupportedNDarray: ...
    @staticmethod
    ...
    @staticmethod
    def from_ndarray(array: _SupportedNDarray, format: str = "rgb24", channel_last: bool = False) -> VideoFrame: ...
    @staticmethod
    def from_bytes(
        data: bytes,
        width: int,
