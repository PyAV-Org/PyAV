...
class InputContainer(Container):
    ...
    @overload
    def demux(self, video_streams: tuple[VideoStream, ...]) -> Iterator[Packet[VideoStream]]: ...
    @overload
    def demux(self, audio_stream: AudioStream) -> Iterator[Packet[AudioStream]]: ...
    @overload
    def demux(self, audio_streams: tuple[AudioStream, ...]) -> Iterator[Packet[AudioStream]]: ...
    @overload
    def demux(self, subtitle_stream: SubtitleStream) -> Iterator[Packet[SubtitleStream]]: ...
    @overload
    def demux(self, subtitle_streams: tuple[SubtitleStream, ...]) -> Iterator[Packet[SubtitleStream]]: ...
    @overload
    def demux(self, data_stream: DataStream) -> Iterator[Packet[DataStream]]: ...
    @overload
    def demux(self, data_streams: tuple[DataStream, ...]) -> Iterator[Packet[DataStream]]: ...
    @overload
    def demux(self, attachment_stream: AttachmentStream) -> Iterator[Packet[AttachmentStream]]: ...
    @overload
    def demux(self, attachment_streams: tuple[AttachmentStream, ...]) -> Iterator[Packet[AttachmentStream]]: ...
    @overload
